...
class CompanyBuyerUserTable extends TableComponent
{
    /**
     * @title Покупатели организации
     *
     * @header
     *
     * {{ button('Добавить пользователя', {type: 'success', size: 'sm', icon: 'plus'}) | open('CompanyBuyerUserEditor', {company_id: _query.companyId}) }}
     *
     ...
     * @field active
     *
     * @col {{ phone | open('CompanyBuyerUserEditor', {key: _key}) }}
     * @col {{ (active ? 'Да' : 'Нет') }}
     */
